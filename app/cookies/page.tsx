    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <div className="flex flex-col items-center">
          ...
          <h1 className="text-3xl font-bold text-center text-teal-800 dark:text-teal-400">Cookie Policy</h1>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto prose dark:prose-invert">
        ...
        <p>
          This Cookie Policy explains how Fipup Generator ("we," "our," or "us") uses cookies and similar technologies
