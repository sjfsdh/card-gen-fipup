    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <div className="flex flex-col items-center">
          ...
          <h1 className="text-3xl font-bold text-center text-teal-800 dark:text-teal-400">
      ...
      <div className="max-w-3xl mx-auto">
        <p className="text-muted-foreground mb-8">
          Find answers to the most common questions about our document and badge generator.
        </p>
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              ...
              documents and badges without creating an account.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              You can download your documents and badges as PNG images or PDF files. Both formats are high-resolution
          ...
          <AccordionItem value="item-4">
            ...
            <AccordionContent>
              Yes, you can upload your own logo, signature, and photos to personalize your documents and badges. We
          ...
          <AccordionItem value="item-5">
            ...
            <AccordionContent>
              Each document and badge is generated with a unique verification code. Anyone can verify the authenticity
              of your document by entering this code on our verification page.
            </AccordionContent>
          </AccordionItem>

          <AccordionItem value="item-6">
            <AccordionTrigger>Can I create multiple documents or badges at once?</AccordionTrigger>
            <AccordionContent>
              Currently, our free service allows you to create one document at a time. For bulk generation, please
              contact us at support@fipup.online for custom solutions tailored to your organization's needs.
            </AccordionContent>
          </AccordionItem>

          <AccordionItem value="item-7">
            <AccordionTrigger>What types of documents and badges can I create?</AccordionTrigger>
            <AccordionContent>
              You can create various types of documents (professional, academic, corporate) and badges (employee, event,
              visitor, security, conference).
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-10">
            ...
            <AccordionContent>
              ...
              or email us at support@fipup.online. You can also call us at +1 (415) 987-6543 during business hours.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
