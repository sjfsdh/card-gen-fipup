    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <div className="flex flex-col items-center">
          ...
          <h1 className="text-3xl font-bold text-center text-teal-800 dark:text-teal-400">Privacy Policy</h1>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto prose dark:prose-invert">
        ...
        <p>
          Welcome to Fipup Generator ("we," "our," or "us"). We respect your privacy and are committed to protecting
        ...
        <p>
          We collect information that you voluntarily provide to us when you use our document and badge creation
          services:
        </p>
        <ul>
          <li>Personal information such as names, email addresses, and phone numbers</li>
          <li>Images uploaded for documents and badges (photos, logos, signatures)</li>
          <li>Content and design preferences for your generated materials</li>
        ...
        <ul>
          ...
          <li>To generate the documents and badges you request</li>
          <li>To enable the verification of documents and badges</li>
