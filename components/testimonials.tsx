...
export function Testimonials() {
  const testimonials = [
    ...
    {
      quote:
        "The document generator is fantastic. Our online course graduates love the professional documents they receive.",
      name: "Emily Jackson",
    ...
    <div className="bg-teal-50/50 dark:bg-teal-950/20 py-16">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4 text-teal-800 dark:text-teal-400">What Our Users Say</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Thousands of organizations use our platform to create professional documents and badges.
          </p>
        </div>
